const ProjectDetails = ({ project }) => {
  return (
    <div className="w-full xl:w-4/5 h-full mx-auto flex flex-wrap xl:gap-4 gap-1 py-4 px-8 bg-white/10 overflow-y-auto my-scrollbar rounded-2xl">
      ...
      <div className="w-full h-[550px] grid auto-rows-min xl:grid-cols-[250px_1fr] lg:grid-cols-[150px_1fr] grid-cols-[120px_1fr] text-white text-sm md:text-xl xl:text-2xl gap-y-4 py-4">
        <p>專案名稱：</p>
